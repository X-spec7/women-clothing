  ...
  if (!product) {
    return (
      <div className="container py-16 text-center">
        <h1 className="font-display text-2xl mb-4">Produkt nie znaleziony</h1>
  ...
  return (
    <div className="container py-8 md:py-12">
      ...
      <nav className="text-xs font-body text-muted-foreground mb-8">
        ...
        <span className="mx-2">/</span>
        <span className="text-foreground">{product.namePl}</span>
      </nav>
        ...
        <div className="flex flex-col">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h1 className="font-display text-2xl md:text-3xl">{product.namePl}</h1>
            </div>
          ...
          {/* Colors */}
          <div className="mt-8">
            <h3 className="text-xs uppercase tracking-wider font-body mb-3">Kolor</h3>
          ...
          <div className="mt-6">
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-xs uppercase tracking-wider font-body">Rozmiar</h3>
          ...
          {/* Quantity */}
          <div className="mt-6">
            <h3 className="text-xs uppercase tracking-wider font-body mb-3">Ilość</h3>
          ...
          <div className="mt-10 pt-8 border-t space-y-4">
            ...
            <div className="flex items-center gap-3 text-sm font-body">
              ...
              <span>2 lata gwarancji jakości</span>
            </div>
          </div>
        </div>
      </div>
      ...
      {relatedProducts.length > 0 && (
        <section className="mt-16 md:mt-24">
          <h2 className="font-display text-2xl mb-8">Może Ci się spodobać</h2>
